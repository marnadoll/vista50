...
projects[boxes][patch][2304795] = http://drupal.org/files/issues/2304795-boxes-revert-4.patch

projects[captcha][version] = 1.1
projects[captcha][patch][825088] = http://drupal.org/files/issues/825088-captcha-export-60_0.patch

projects[colorbox][version] = 1.6

projects[comment_notify][version] = 1.2
projects[comment_notify][patch][1892658] = http://drupal.org/files/issues/1892658-comment_notify-node_type_default-6.patch

projects[conditional_styles][version] = 2.2

projects[context][version] = 3.2
projects[context][patch][1892658] = http://drupal.org/files/issues/455908-context-weight-123.patch
...
projects[defaultcontent][patch][2292813] = http://drupal.org/files/issues/2292813-defaultcontent-files-2.patch
projects[defaultcontent][patch][2303163] = http://drupal.org/files/issues/2303163-defaultcontent-pathauto-2.patch

projects[delta][version] = 3.0-beta11
projects[delta][patch][1532196] = http://drupal.org/files/breadcrumb_empty_despite_current_enabled-1532196-2.patch

projects[diff][version] = 3.2

projects[entity][version] = 1.5
projects[entity][patch][2307807] = http://drupal.org/files/issues/2307807-entity-reset-insert-1.patch

projects[entity_autocomplete][version] = 1.0-beta3

projects[entity_boxes][version] = 1.0-alpha2
projects[entity_boxes][patch][2304797] = http://drupal.org/files/issues/2304797-entity-boxes-export-6.patch
projects[entity_boxes][patch][2047875] = http://drupal.org/files/issues/2047875-entity_boxes-install-6.patch
...
projects[features][patch][2314181] = http://drupal.org/files/issues/2314181-features-drupal_static-1.patch
...
projects[fullcalendar][download][branch] = e416e71
...
projects[references_dialog][patch][1774466] = http://drupal.org/files/issues/references_dialog_ui_improvements-1774466-24.patch

projects[rubik][version] = 4.1
projects[rubik][subdir] = ''
projects[rubik][patch][1556392] = http://drupal.org/files/rubik-fix-ie-filefield-input-1556392-1.patch
